...
export class WebSocketManager {
  ...
  initialize(httpServer: any): void {
    ...
    this.io = new Server(httpServer, {
      ...
      reconnection: true,
      reconnectionDelay: this.config.reconnectConfig.initialDelay,
      reconnectionDelayMax: this.config.reconnectConfig.maxDelay,
      reconnectionAttempts: this.config.reconnectConfig.maxRetries,
